...
//	CLOCK("uart_clk",	UART2_CLK,	&msm_device_uart2.dev, 0),
	CLOCK("uart_clk",	UART2_CLK,	&msm_device_uart2.dev, OFF),
...
//	CLOCK("uartdm_clk",	UART2DM_CLK,	&msm_device_uart_dm2.dev, 0),
	CLOCK("uartdm_clk",	UART1DM_CLK,	&msm_device_uart_dm1.dev, 0),
	CLOCK("uartdm_clk",	UART2DM_CLK,	&msm_device_uart_dm2.dev, OFF),
