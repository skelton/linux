...
/* ----- combo ?------- */
 ...
 T2M1    0, 1, 0x15, 0x14, 5, 0x17, 0x16, 0x18, 0x20, 4, 2, 3,
         QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, 0x21, 0xc, 0xd, 0x23, QDSP_MODULE_MAX, QDSP_MODULE_MAX

 Q2OFF1  0x6ec, 0x698, QDSP_RTOS_NO_QUEUE, 0x6ac, 0x6c0, 0x6c4, 0x6bc,          
         0x6a0, 0x6a4, 0x6a8, 0x6c8, 0x6cc, 0x6d0, 0x6e0, QDSP_RTOS_NO_QUEUE,
         QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, 0x6d4, 0x6dc, 0x6d8,
         0x6e8, 0x6e4, 0x69c, 0x6b0, 0x6b8, 0x6b4;

/* ------ gaudio ?------ */

 T2M2    1, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, 4, 2,
         3, 0x27, 0x28, 0x29, QDSP_MODULE_MAX, 0xc, 0xd, QDSP_MODULE_MAX, 0x2a, QDSP_MODULE_MAX;

/* -----qtv_lp ? ------- */

 T2M3    1, QDSP_MODULE_MAX, QDSP_MODULE_MAX, 5, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, 4, 2, 
         QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, 0xc, 0xd, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX;

 Q2OFF3  QDSP_RTOS_NO_QUEUE, 0x3f0, 0x420, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE,         
         QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, 
         0x3f4, 0x3f8, 0x3fc, 0x40c, 0x410, 0x414, 0x418, 0x41c, 0x400, 0x408, 
         0x404, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE,
         QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE;

/* ---- ? -------- */
 T2M4    1, 0x15, 0x14, QDSP_MODULE_MAX, QDSP_MODULE_MAX, 0x16, QDSP_MODULE_MAX, QDSP_MODULE_MAX, 4, QDSP_MODULE_MAX,
         QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX, QDSP_MODULE_MAX;

 Q2OFF4  QDSP_RTOS_NO_QUEUE, 0x43a, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, 0x43e, 0x442,
         QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, 
         0x44a, 0x44e, 0x452, 0x45e, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, 0x446, 0x45a, 
         0x456, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE;

/* ----- ? ------- */

 Q2OFF5  QDSP_RTOS_NO_QUEUE, 0x55a, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE,
         QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, 0x562, 0x566, 0x56a, 
         0x56e, 0x572, 0x576, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, 
         QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, 0x55e, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE, QDSP_RTOS_NO_QUEUE;
#endif
...
typedef enum { 
	...
	QDSP_MODULE_DTMF,		// 0x2a dummy
	QDSP_MODULE_DTMF,		// 0x2b dummy
	QDSP_MODULE_DTMF,		// 0x2c dummy
	QDSP_MODULE_DTMF,		// 0x2d dummy
